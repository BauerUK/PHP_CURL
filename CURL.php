...
class CURL {
	...
	// TODO: allow for 'add...' functions to add one element at a time for the
	// following array-based functions
	...
	public function setHttp200Aliases(array $value) {
		return $this->setOption(CURLOPT_HTTP200ALIASES, $value);
	}
	...
	public function setHttpHeader(array $value) {
		return $this->setOption(CURLOPT_HTTPHEADER, $value);
	}
